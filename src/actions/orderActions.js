...
////new order creation by customer
...
////sending request to get the order details from DB
...
//getting list of orders history for specific user //for user
...
export const deleteOrder = (orderId) => async (dispatch, getState) => {
  ...
  try {
    const { data } = Axios.delete(`${url}/orders/${orderId}`, {
      headers: { Authorization: `Bearer ${userInfo.token}` },
    })
...
////delivering order status change by admin
